...
Expected settings include the Azure Search endpoint, News Archive index name, Image Archive index name, article semantic configuration, and authentication configuration. Provider-specific index field mappings are code-defined rather than environment-defined.
